...
def cmd_start(message):
    ...
    try:
        ...
        response = f"""
🤖 <b>Synthora Elite 12345678901345</b>
...
def cmd_status(message):
    ...
    try:
        response = f"""
📊 <b>Synthora Elite 12345678901345 - Status</b>
...
async def scan_new_pools():
    ...
    logger.info("🔍 Synthora Elite 123456789013451 - Sniper Engine gestart...")
    ...
    while True:
        try:
            ...
            # Get PoolCreated events using Web3.py v7 syntax (with underscores!)
            try:
...
def main():
    """Main entry point"""
    logger.info(f"✅ Synthora Elite 12345678901345 gestart op {config.WALLET_ADDRESS}")
