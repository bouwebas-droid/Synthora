...
# Gebruik je eigen API key uit de logs
...
# Belangrijk voor de hash: Chain ID van Base
CHAIN_ID = 8453
...
def calculate_user_op_hash(user_op):
    ...
    # 1. Pack de individuele bytes velden
    ...
    # 2. Hash met EntryPoint en ChainID
