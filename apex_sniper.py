...
# =============================================================
MAX_BLOCK_RANGE = 1999  # Alchemy max is 2000 blocks per request
...
async def run_bot():
    ...
    for cmd, fn in [("start", cmd_start), ("stop", cmd_stop), ("status", cmd_status), ("stats", cmd_stats), ("set", cmd_set), ("buy", cmd_buy), ("sell", cmd_sell), ("closeall", cmd_closeall), ("skyline", cmd_skyline)]:
