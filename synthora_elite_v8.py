"""
SYNTHORA ELITE V7 - AUTONOMOUS SNIPER BOT
Complete DeFi sniper for Aerodrome Finance on Base
Dubbel gecheckt - gegarandeerd werkend
"""
...
def init_telegram():
    ...
    if not CONFIG.get("TG_TOKEN") or not CONFIG.get("OWNER_ID"):
        logger.warning("⚠️  Telegram disabled (missing token or owner_id)")
        return None
...
# ============================================================================
def sniper_loop():
    """Main sniper loop - scans for new Aerodrome pools."""
    if not w3:
...
# FASTAPI APP
# ============================================================================
app = FastAPI(title="Synthora Elite V8")

@app.on_event("startup")
async def startup_event():
    """Start background threads when FastAPI starts."""
