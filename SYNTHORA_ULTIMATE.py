...
# YOUR METAMASK FOR WITHDRAWALS
METAMASK_ADDRESS = "0xaF2C5d0063C236C95BEF05ecE7079f818EFBBF38"
...
try:
    ...
    if my_addr.lower() != expected_addr.lower():
        logger.warning("⚠️ Wallet mismatch! Using: %s | Expected: %s", my_addr, expected_addr)
    else:
        logger.info("💎 Trading Wallet: %s ✅", my_addr)
