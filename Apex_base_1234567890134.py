...
def cmd_start(message):
    ...
    try:
        ...
        response = f"""
🤖 <b>Synthora Elite 1234567890134</b>
...
def cmd_status(message):
    ...
    try:
        response = f"""
📊 <b>Synthora Elite 1234567890134 - Status</b>
...
async def scan_new_pools():
    ...
    logger.info("🔍 Synthora Elite 12345678901341 - Sniper Engine gestart...")
    ...
    while True:
        try:
            ...
            # Get PoolCreated events using Web3.py v7 syntax
            try:
...
def main():
    """Main entry point"""
    logger.info(f"✅ Synthora Elite 1234567890134 gestart op {config.WALLET_ADDRESS}")
