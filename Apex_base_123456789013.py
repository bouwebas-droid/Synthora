...
def cmd_start(message):
    ...
    try:
        ...
        response = f"""
🤖 <b>Synthora Elite 123456789013</b>
...
def cmd_status(message):
    ...
    try:
        response = f"""
📊 <b>Synthora Elite 123456789013 - Status</b>
...
async def scan_new_pools():
    ...
    logger.info("🔍 Synthora Elite 1234567890131 - Sniper Engine gestart...")
...
def main():
    """Main entry point"""
    logger.info(f"✅ Synthora Elite 123456789013 gestart op {config.WALLET_ADDRESS}")
